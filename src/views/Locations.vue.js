...
if (__VLS_ctx.loading) {
    ...
    __VLS_asFunctionalElement(__VLS_elements.tbody, __VLS_elements.tbody)({});
    for (const [l] of __VLS_getVForSourceType((__VLS_ctx.items))) {
        // @ts-ignore
        [items,];
        __VLS_asFunctionalElement(__VLS_elements.tr, __VLS_elements.tr)({
            key: (l.id),
...
/** @type {[typeof LocationModal, ]} */ ;
// @ts-ignore
const __VLS_0 = __VLS_asFunctionalComponent(LocationModal, new LocationModal({
    ...{ 'onSaved': {} },
    ref: "modal",
}));
